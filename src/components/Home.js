...
export default function Home() {
  ...
  const sendTransaction = async () => {
    ...
    const balance = balances.rawGLMS
  ...
  console.log(typeof balances.GLMS === "number")
  console.log(balances)
  return (
    <div className="home">
      <h2>
        {balances &&
          (typeof balances.GLMS === "number"
            ? balances.GLMS.toLocaleString("en-US", { maximumFractionDigits: 6 })
            : "Loading...")}{" "}
        GLMS
      </h2>
